...
gen_file_path = r'/sorc001/BATCH/GEN/' + juje + '/' + sys.argv[1] + '_' + sys.argv[2] + '.sql'
log_file_name = r'/logs001/BATCH/LOG/' + juje + '/log_' + sys.argv[1] + '_' + sys.argv[2] + '.dat'
...
try:
    ...
    def get_secret():
        secret_name = "arn:aws:secretsmanager:ap-northeast-2:914683995584:secret:dept-sm-an2-an-dwdev-rsc-ansla-dSyf30"
    ...
    if output is not None:
        ...
        if cnt > 1:
            ...
            if results > 0:
                ...
                logger.warning("■ 프로세스 or 로그 테이블 확인 필요.")
                logger.warning("=======================================================")
                totlog += "=======================================================\n"
                totlog += "                     <프로그램 오류>\n"
        ...
        for sql in sql_array:
            ...
            if (sql.strip() != ""):
                try:
                    ...
                    df.to_csv('/data001/sapdata/SCM_USR_M.csv', index=False)
