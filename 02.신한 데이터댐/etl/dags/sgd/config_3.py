...
redshift_env = {
    'copy_options': {  # list
        'shb': ["csv quote as '\036'", "delimiter '\037'"],
        'shc': ["csv quote as '\036'", "delimiter '|'"],
        'shi': ["csv quote as '\036'", "IGNOREHEADER 1", "delimiter '~'"],
        'shl': ["csv quote as '\036'", "delimiter '|'"],
        'pbc': ["csv quote as '\036'", "delimiter ','"],
    },
    'unload_options': {
