...
"""
s3_file_prefix = f'iid_jdc013t00_{execution_kst}'
...
select_sql_for_insert = f"""
    insert into l0_shi.jdc013t00
                ...
                , ctac_bran_headq_code                    -- 연계지점본부코드
                , acct_mang_dbrn_code                     -- 계좌관리부점코드
                , acct_mang_headq_code                    -- 계좌관리본부코드
                ...
                , stk_conf_cmsn_aplc_ymd                  -- 주식협의수수료적용일자
                , fuop_acct_yn                            -- 선물옵션계좌여부
                , saly_trns_yn                            -- 급여이체여부
                ...
                , desi_dd_auto_trns_rcpt_yn               -- 지정일자동이체입금여부
                , desi_dd_auto_trns_outm_yn               -- 지정일자동이체출금여부
