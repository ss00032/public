...
"""
s3_file_prefix = f'ild_da_pacomn_cls_/ild_da_pacomn_cls_{execution_kst}'
...
delete_sql_for_merge = f"""
        delete from l0_shl.da_pacomn_cls
              where 1 = 1 
"""
...
select_sql_for_insert = f"""
    insert into l0_shl.da_pacomn_cls
                (
                  aws_ls_dt                               -- aws적재일시
                , clos_ym                                 -- 마감년월
                , inon_no                                 -- 보험계약번호
