...
"""
s3_file_prefix = f'icd_mtfua0012_/icd_mtfua0012_{execution_kst}'
...
select_sql_for_insert = f"""
    insert into l0_shc.mtfua0012
                ...
                , rlp_cus_tf                              -- 실질회원tf
                , lat_cus_tf                              -- 신규회원tf
                , o_crd_cry_tf                            -- 본인카드소지tf
                , fml_crd_cry_tf                          -- 가족카드소지tf
                , cre_crd_cry_tf                          -- 신용카드소지tf
                , chc_cry_tf                              -- 체크카드소지tf
                , soh_tf                                  -- 소호tf
                , iss_ms_cn                               -- 발급개월수
                , hga                                     -- 취급금액
                ...
                , lm_ta_lon_hga                           -- 한도기준론취급금액
                , cus_lon_hga                             -- 회원론취급금액
                , dfl_hga                                 -- 대환론취급금액
                , ucs_lon_hga                             -- 비회원론취급금액
                , lnp_hga                                 -- 론패스취급금액
                , spr_st_hga                              -- 분할결제취급금액
                , chc_hga                                 -- 체크카드취급금액
                ...
                , lm_ta_lon_ue_ct                         -- 한도기준론이용건수
                , cus_lon_ue_ct                           -- 회원론이용건수
                , dfl_ue_ct                               -- 대환론이용건수
                , ucs_lon_ue_ct                           -- 비회원론이용건수
                , lnp_ue_ct                               -- 론패스이용건수
                ...
                , lon_ue_tf                               -- 론이용tf
                , cus_lon_ue_tf                           -- 회원론이용tf
                , dfl_ue_tf                               -- 대환론이용tf
                , ucs_lon_ue_tf                           -- 비회원론이용tf
                , lnp_ue_tf                               -- 론패스이용tf
                ...
                , lon_ue_ttn_cd                           -- 론이용패턴코드
                , cus_lon_ue_ttn_cd                       -- 회원론이용패턴코드
                , dfl_ue_ttn_cd                           -- 대환론이용패턴코드
                , ucs_lon_ue_ttn_cd                       -- 비회원론이용패턴코드
                , lnp_ue_ttn_cd                           -- 론패스이용패턴코드
                ...
                , dpr_ue_ttn_cd                           -- 백화점이용패턴코드
                , oln_ue_ttn_cd                           -- 주유이용패턴코드
                , cmu_crg_ue_ttn_cd                       -- 통신요금이용패턴코드
                , trf_ue_ttn_cd                           -- 교통이용패턴코드
                , blp_dum_ue_ttn_cd                       -- 대형할인마트이용패턴코드
                , iu_ue_ttn_cd                            -- 보험이용패턴코드
                , apo_ue_ttn_cd                           -- 아파트관리비이용패턴코드
                , et_ue_ttn_cd                            -- 기타이용패턴코드
                , cex_et_ue_ttn_cd                        -- 복합기타이용패턴코드
                , cl_mw50_ab_ue_ttn_cd                    -- 신판50만원이상이용패턴코드
                , cl_mw100_ab_ue_ttn_cd                   -- 신판100만원이상이용패턴코드
                , ue_mct_ct                               -- 이용가맹점건수
                , to_cv_hga                               -- 총현금서비스취급금액
                , to_cv_ue_ct                             -- 총현금서비스이용건수
                , to_cv_ue_tf                             -- 총현금서비스이용tf
                , to_cv_ue_ttn_cd                         -- 총현금서비스이용패턴코드
