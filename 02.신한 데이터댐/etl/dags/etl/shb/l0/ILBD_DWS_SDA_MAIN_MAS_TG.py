...
(@) 프로그램 ID
"""
pgm_id = 'ILBD_DWS_SDA_MAIN_MAS_TG'
...
"""
s3_file_prefix = f'ibd_dws_sda_main_mas_/ibd_dws_sda_main_mas_{execution_kst}'
...
delete_sql_for_merge = f"""
        delete from l0_shb.dws_sda_main_mas
              where 1 = 1 
"""
...
select_sql_for_insert = f"""
    insert into l0_shb.dws_sda_main_mas
                (
                  aws_ls_dt                               -- aws적재일시
                , ci_no                                   -- ci번호
                , cusno                                   -- 고객번호
