...
(@) 프로그램 ID
"""
pgm_id = 'ALBD_DWY_YER_LONKIMAS_M_TG'
...
"""
s3_file_prefix = f'abd_dwy_yer_lonkimas_m_/abd_dwy_yer_lonkimas_m_{execution_kst}'
...
delete_sql_for_merge = f"""
        delete from l0_shb.dwy_yer_lonkimas_m
              where 1 = 1 
"""
...
select_sql_for_insert = f"""
    insert into l0_shb.dwy_yer_lonkimas_m
                (
                  aws_ls_dt                               -- aws적재일시
    ...
    select  current_timestamp AT TIME ZONE 'Asia/Seoul' 
          ...
          , iche_cnt                                -- 이체건수
          , sugg_feamt                              -- 권유수수료금액
      from w0_shb.dwy_yer_lonkimas_m
"""
