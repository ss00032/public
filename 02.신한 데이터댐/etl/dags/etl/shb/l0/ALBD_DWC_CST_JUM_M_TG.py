...
"""
s3_file_prefix = f'abd_dwc_cst_jum_m_/abd_dwc_cst_jum_m_{execution_kst}'
...
delete_sql_for_merge = f"""
        delete from l0_shb.dwc_cst_jum_m
              where 1 = 1 
"""
...
select_sql_for_insert = f"""
    insert into l0_shb.dwc_cst_jum_m
                (
                  aws_ls_dt                               -- aws적재일시
                , dw_bas_nyymm                            -- 기준년월
                , ci_no                                   -- ci번호
