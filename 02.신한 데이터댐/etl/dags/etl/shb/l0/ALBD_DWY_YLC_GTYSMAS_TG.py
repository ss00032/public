...
(@) 프로그램 ID
"""
pgm_id = 'ALBD_DWY_YLC_GTYSMAS_TG'
...
"""
s3_file_prefix = f'abd_dwy_ylc_gtysmas_/abd_dwy_ylc_gtysmas_{execution_kst}'
...
delete_sql_for_merge = f"""
        delete from l0_shb.dwy_ylc_gtysmas
              where 1 = 1 
"""
...
select_sql_for_insert = f"""
    insert into l0_shb.dwy_ylc_gtysmas
                (
                  aws_ls_dt                               -- aws적재일시
                , ci_no                                   -- ci번호
                , cusno                                   -- 고객번호
                ...
                , corp_bdaj_yc_jeyn                       -- 기업채권조정연체제외여부
